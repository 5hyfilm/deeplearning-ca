...
def my_decode_predictions(preds, top=2, class_list_path='/content/AJPom_cancer_data/nmVScancer/nmVScancer_data_index.json'):
...
def compute_saliency(model, guided_model, img_path, layer_name='block5_conv3', cls=-1, visualize=True, save=True):
    ...
    class_name = my_decode_predictions(np.eye(1, 2, cls))[0][0][1]
